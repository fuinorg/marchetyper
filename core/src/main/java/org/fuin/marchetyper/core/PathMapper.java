...
public final class PathMapper {
     ...
     */
    public PathMapper(@NotNull final File srcDir, @NotNull final File destDir, @NotNull final Mapping... mappings) {
     ...
     */
    public PathMapper(@NotNull final File srcDir, @NotNull final File destDir, @NotNull final List<Mapping> mappings) {
        super();
